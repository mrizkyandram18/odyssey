...
func TestIsPrerequisiteMet_RealmNotActive(t *testing.T) {
	...
	if svc.IsPrerequisiteMet(context.Background(), def, "crew-1", "u1") {
		t.Error("expected false when journey not active")
	}
}
...
func TestIsPrerequisiteMet_RealmActive(t *testing.T) {
	...
	if !svc.IsPrerequisiteMet(context.Background(), def, "crew-1", "u1") {
		t.Error("expected true when journey active")
	}
}
...
func TestIsPrerequisiteMet_ChapterNotUnlocked(t *testing.T) {
	...
	if svc.IsPrerequisiteMet(context.Background(), def, "crew-1", "u1") {
		t.Error("expected false when course not unlocked")
	}
}
...
func TestIsPrerequisiteMet_ChapterUnlocked(t *testing.T) {
	...
	if !svc.IsPrerequisiteMet(context.Background(), def, "crew-1", "u1") {
		t.Error("expected true when course unlocked")
	}
}
...
func (m *mockQuestGate) IsChapterUnlocked(ctx context.Context, crewID, course string) bool {
	return m.chapterUnlocked
}
func (m *mockQuestGate) IsRealmActive(ctx context.Context, crewID, journey string) bool {
...
func (m *mockContentGatewayWithQuests) ListQuestsByRealm(ctx context.Context, journey string) ([]gamecontent.QuestDefinition, error) {
