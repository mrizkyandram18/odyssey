...
export function CollectionInventoryPage() {
  const [collections, setRelics] = useState<InventoryItem[]>([])
  ...
  const totalCollected = collections.reduce((acc, curr) => acc + curr.owned_count, 0)
    ...
    <div className="flex flex-col gap-8 max-w-6xl mx-auto py-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="text-center p-4">
          <p className="text-3xl font-heading text-accent-reward mb-1">{collections.length}</p>
