...
| **Trading** | Players trade Collections with each other. Requires mutual agreement; no auction house. Peer-to-peer only. | Phase 2 |
...
| **Voice Chat** | In-quest voice chat for relay missions. Optional and always opt-in. | Phase 3 |
...
| **AI Mission Generator** | Procedurally generates daily turns tailored to interests. | Phase 4 |
| **AI Comic** | Converts story submissions into illustrated comics. | Phase 4 |
| **AI Quiz** | Generates educational puzzle exercises on demand. | Phase 3 |
...
| **Photo Album** | A gallery view of all `PHOTO`-kind submissions, organized by journey and date. | Phase 3 |
| **Video Reel** | A gallery of `VIDEO`-kind submissions, compiled into a family story reel. | Phase 4 |
| **Mini-Games** | Simple, single-tap mini-games (e.g., a reaction test, a quick puzzle) embedded in missions. | Phase 2 |
...
| Idea | Description | Phase |
|---|---|---|
| **Inventory** | A catalog of collected items (Collections, tools, cosmetics). Phase 2 adds trading. | Phase 2 |
...
| **Achievement Showcase** | A dedicated screen where earned Collections and Achievements are displayed in an interactive gallery. | Phase 3 |
| **Custom Missions** | Family members author and share custom missions with each other (peer-to-peer). | Phase 3 |
