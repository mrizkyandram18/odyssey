...
VALUES
  ('whispering-woods', 'Whispering Woods', 'A gentle forest realm of moss, light, and quiet secrets.', 1, 100, '🌲', true, 1),
...
VALUES
  ('wooden-chest', 'Wooden Chest', 'COMMON', '📦', 'A simple wooden chest, worn by time but still holding surprises.', true, 1),
  ('bronze-chest', 'Bronze Chest', 'UNCOMMON', '🟤', 'A sturdy bronze chest with ornate fittings and a satisfying click.', true, 1),
  ('silver-chest', 'Silver Chest', 'RARE', '⚪', 'A polished silver chest that gleams in the dark. Rare and rewarding.', true, 1),
  ('golden-chest', 'Golden Chest', 'EPIC', '🟡', 'A magnificent golden chest, warm to the touch and heavy with reward.', true, 1),
  ('mystic-chest', 'Mystic Chest', 'LEGENDARY', '🔮', 'An otherworldly chest that hums with arcane energy. The rarest find.', true, 1)
ON CONFLICT (slug) DO NOTHING;
...
VALUES
  ...
  ('realm-totem', 'Realm Totem', 'A carved totem that represents the heart of a realm.', 'whispering-woods', 'EPIC', '🏺', 'Carved from the heartwood of the world-tree. It resonates with the spirit of the forest.', true, 1),
