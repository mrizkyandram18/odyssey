...
func TestCrews_Handler_MethodNotAllowed(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/families", nil)
...
func TestCrews_Handler_PatchSuccess(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPatch, "/api/families", marshalJSON(t, body))
	req.Header.Set("Authorization", "Bearer "+token)
...
func TestCrews_Handler_PatchUnauthorized(t *testing.T) {
	Setup(&mockCrewStore{crew: makeCrew()}, nil)
	req := httptest.NewRequest(http.MethodPatch, "/api/families", nil)
	w := httptest.NewRecorder()
	Handler(w, req)
...
func TestCrews_Handler_PatchBadRequest(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPatch, "/api/families", strings.NewReader("not-json"))
	req.Header.Set("Authorization", "Bearer "+token)
	req.Header.Set("Content-Type", "application/json")
	w := httptest.NewRecorder()
	mw.RequireAuth(Handler)(w, req)
